...
<body>
    ...
    <div class="container">
        ...
        <div class="acc">
            <h3>Question 5: What is Flupke?</h3>
            <div class="faq-content">
                <div class="content-inner">
                    <p> There is only Flupke in the Fontys He is known for his funny style of teaching such as his
                        shouting speeds during lecture goes from <b>20 mile/hr </b>to <b> 180/hr </b>secondly if you
                        ask him a simple
                        question Blipo which is his other name, will asnwer you in such way that you get totally lost,
                        by the time you forgot the question you have asked. overall Flupke is a good teacher BUT not
                        for the ICT fresh strater. </p>
                </div>
            </div>
        </div>
    </div>
